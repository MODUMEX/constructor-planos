/* GENERADO desde las listas de precios de México y de LATAM — no editar a mano */

/**
 * Una pieza suelta con precio POR UNIDAD, no por m².
 *
 * Cada artículo trae su precio en las dos listas: la de LATAM en dólares y la
 * de México en pesos. Para Costa Rica se usa el de dólares por el tipo de
 * cambio, que es la misma regla que ya usan los modelos `usdOnly`.
 */
